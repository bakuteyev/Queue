...
//стала больше 0.3 (на распечатке это значение в самой нижней строчке правее знака «{3}»).
    ...
    public static void main(String[] args) {
        ...
        test_TaskNUnits();
        //------------------------------------------------
        // число обращений: 1000000;
        // количество приборов: 3;
        // среднее число обращений в единицу времени: 1.1;
        // среднее время обслуживания: 1.0940000000000007;
        // число мест для ожидания: 10;
        // время нахождения в системе --- среднее:  1.1489069012873112, наибольшее: 8.498729517057267;
        // время ожидания --- среднее: 0.054801155613556876, наибольшее: 7.6787692356156185;
        // длина очереди ---  средняя: 0.060245060006443744, наибольшая: 8.0, конечная: 0.0;
        // вероятность отказа в обслуживании: 0.0;
        // среднее число свободных приборов: 1.7972622417471948;
        // относительный простой всех приборов: 1.7972622417471715;
        // средний относительный простой одного прибора: 0.5990874139157238;
        // вероятность числа свободных приборов и относительный простой каждого прибора
        //{0}     0.13736668932305895             [0]     0.5583884035924044
        //{1}     0.2282801695463442              [1]     0.5934450745571824
        //{2}     0.33407735119107157             [2]     0.6454287635975847
        //{3}     0.30027578993956916
    }
